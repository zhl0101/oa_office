...
public class Tasklist implements Serializable{
    ...
    public Tasklist(Long typeId, Date publishTime, Date starTime, Date endTime, Date modifyTime, String title, String reciverlist, User usersId, String taskDescribe, String comment, Boolean top, Boolean cancel, String ticking, Integer statusId) {
