...
public class ProcessList {
    ...
    public ProcessList(String typeNmae, Long statusId, Long deeply, String processName, String processDescribe, User userId, Date applyTime, Boolean rejected, Date startTime, Date endTime, Double procseeDays, Attachment proFileid, String shenuser) {
