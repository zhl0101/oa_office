 ...
 * @Description TODO 邮箱账号表
 * @Author Administrator
 * @Date 2019/4/27 0027 10:53
 * @Version 1.0
 */
@Entity
...
public class Mailnumber {
    ...
    public Mailnumber(Long mailType, Long status, User mailUserId, String mailUserName, Date mailCreateTime, String mailAccount, String password, String mailDes) {
