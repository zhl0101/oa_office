...
/**
 * @ClassName Traffic
 * @Description TODO 交通费用明细表
 * @Author Administrator
 * @Date 2019/4/27 0027 11:26
 * @Version 1.0
 */
@Entity
...
public class Traffic {
    ...
    public Traffic(User user, Date departTime, String departName, String reachName, String trafficName, String seatType, Double trafficMoney, EvectionMoney evection, String username) {
