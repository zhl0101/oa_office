package com.zhl.oa.controller.note;
...
import com.zhl.oa.model.dao.notedao.*;
...
import com.zhl.oa.model.entity.note.Catalog;
	...
	public String testdfddf(@RequestParam("file") MultipartFile file, @Valid Note note2, BindingResult br,
		...
		if (!ResultEnum.SUCCESS.getCode().equals(res.getCode())) {
			...
			if (nid == -1 || nid == -3) {
				...
				// 0l表示新建的时候默认为没有收藏
				note = new Note(note2.getTitle(), note2.getContent(), catalogId,
						typeId, statusId, attid, new Date(), 0l);
				// 判断是否共享
