package com.zhl.oa.common.Interceptor;

import com.zhl.oa.common.Tool;
import com.zhl.oa.model.dao.roledao.RolepowerlistDao;
import com.zhl.oa.model.dao.system.SystemMenuDao;
...
public class recordInterceptor extends HandlerInterceptorAdapter{
	...
	public boolean preHandle(HttpServletRequest request,
		...
		List<Rolemenu> oneMenuAll=rpdao.findbyparentxianall(0L, user.getRole().getRoleId(),
				true,false);
		List<Rolemenu> twoMenuAll=rpdao.findbyparentsxian(0L, user.getRole().getRoleId(),
				true,false);
